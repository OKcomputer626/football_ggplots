...
```{r}
ggsave(plot = lafc_final_plot, "..../lafc_age_utility_2021.png",
       height = 8, width = 15)
```

```{r}
plot_logo <- add_logo(plot_path = "..../lafc_age_utility_2021.png",
...
```{r}
image_write(image = plot_logo, "..../lafc_age_utility_2021.png")
```
