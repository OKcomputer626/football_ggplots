...
df <- get_data(1628369, "2021-22", "Regular Season")
...
p1 <- plot_court(court_themes$light) +
  ...
  scale_fill_distiller(direction = -1, 
                       palette = "RdBu", 
                       limits = c(.5, 1.5), 
                       breaks = seq(.5, 1.5, .125),
                       labels = c(".5", ".625", ".75", ".875", "1", "1.125", "1.25", "1.375", "1.5"),
                       "Points per shot") +
  ...
  labs(title = "Jayson Tatum \n 2021-22 Regular Season",
       subtitle = "Less than 8 ft. - 61.4% | 8-16 ft. - 33.5% | 16-24 ft. - 40.1% | 3P - 35.5% \n Less than 8 ft. - 354/577 | 8-16 ft. - 60/179 | 16-24 ft. - 63/157 | 3P - 231/649",
       caption = "NBA API \n @AndresAnalytics")
ggdraw(p1) +
...
Tatum_plot <- read_pptx()
Tatum_plot <- add_slide(Tatum_plot)
Tatum_plot <- ph_with(x = Tatum_plot, value = anyplot,
                   location = ph_location_fullsize())

fileout <- "Tatum_plot.pptx"
print(Tatum_plot, target = fileout)
```
