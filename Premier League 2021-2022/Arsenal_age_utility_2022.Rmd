...
```{r}
ggsave(plot = combined_plot, "C:/Users/16267/Downloads/arsenal_age_utility_2022.png",
       height = 8, width = 15)
```

```{r}
plot_logo <- add_logo(plot_path = "C:/Users/16267/Downloads/arsenal_age_utility_2022.png",
...
```{r}
image_write(image = plot_logo, "C:/Users/16267/Downloads/arsenal_age_utility_2022.png")
```
